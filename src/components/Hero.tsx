        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-slide-up">
            ...
            <div className="space-y-4">
              {[
                "Implementaciones rápidas y medibles",
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Button
                asChild
                size="lg"
                className="bg-violet-purple hover:bg-violet-purple/90 text-white shadow-lg shadow-violet-purple/30 transition-all duration-300 hover:shadow-xl hover:shadow-violet-purple/40 hover:scale-105 text-base"
              >
                <a
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="border-white/30 text-white hover:bg-white/10 hover:border-white/50 transition-all duration-300 text-base"
              >
                <a
                  href="https://calendly.com/violet-wave/asesoramiento?month=2025-11"
                  target="_blank"
            ...
            <div className="flex flex-wrap gap-6 pt-4 text-sm text-text-secondary">
              <div className="flex items-center space-x-2">
                <div className="w-2 h-2 rounded-full bg-violet-purple" />
                <span>Proyectos implementados con ROI positivo</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-2 h-2 rounded-full bg-violet-purple" />
                <span>Tecnología de vanguardia aplicada a casos reales</span>
              </div>
            </div>
          </div>
          ...
          <div className="relative flex items-center justify-center animate-fade-in">
            <div className="relative w-full max-w-md">
              ...
              <div className="relative bg-accent-navy/50 backdrop-blur-sm rounded-3xl p-12 border border-violet-purple/20 shadow-2xl">
                <div className="space-y-8">
                  <img
                    src={logoCompleto}
                    alt="Violet Wave Logo Completo"
